...
CREATE TABLE "new_SubjectStudents" (
    ...
    CONSTRAINT "SubjectStudents_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("email") ON DELETE SET NULL ON UPDATE CASCADE
);
...
INSERT INTO "new_User" ("lastName", "name", "role") SELECT "lastName", "name", "role" FROM "User";
DROP TABLE "User";
...
CREATE TABLE "new__StudentSubjects" (
    ...
    CONSTRAINT "_StudentSubjects_B_fkey" FOREIGN KEY ("B") REFERENCES "User" ("email") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new__TeacherSubjects" (
    ...
    CONSTRAINT "_TeacherSubjects_B_fkey" FOREIGN KEY ("B") REFERENCES "User" ("email") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Grade" (
    ...
    CONSTRAINT "Grade_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("email") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_Subject" (
    ...
    CONSTRAINT "Subject_teacherId_fkey" FOREIGN KEY ("teacherId") REFERENCES "User" ("email") ON DELETE RESTRICT ON UPDATE CASCADE
);
